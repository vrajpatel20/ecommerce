					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 9328006926</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> tulsionmark@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
						  <div class="panel panel-default">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Jalaram</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Gayatri</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Yash</a></h4>
								</div>
							</div>
...
<?php
				...
				{
					$result = mysqli_query($conn,"SELECT * FROM products  where Category='Laptops'");
...
<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2021 Tulsionmark. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="#">Tulsionmark Tech Team</a></span></p>
				</div>
			</div>
		</div>
